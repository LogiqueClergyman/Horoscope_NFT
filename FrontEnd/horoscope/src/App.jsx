...
const NFT_CONTRACT_ADDRESS = "0xD2269d36077584B20cAA0985Fa5576bA30110D61";
...
function App() {
  ...
  async function mintNFT() {
    ...
    // Log the new token ID
      console.log("New Token ID:", receipt.events[0].args.tokenId.toNumber());
